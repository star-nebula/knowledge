...
const techTags: TechTag[] = [
  ...
  { name: 'DeepSeek', group: 'llm', tooltip: '核心推理模型，用于选品分析、客服意图识别', link: '/vault/Knowledge/AI/DeepSeek' },
  { name: 'ReAct', group: 'llm', tooltip: 'Agent推理范式，实现工具调用与思维链推理', link: '/vault/Knowledge/AI/LangChain Agents 组件' },
  { name: 'vLLM', group: 'llm', tooltip: '本地模型推理部署框架，支撑14B模型低延迟服务', link: '/vault/Knowledge/AI/大模型-知识扩展' },
  { name: 'LoRA', group: 'llm', tooltip: '模型微调技术，用于垂直领域模型适配', link: '/vault/Knowledge/AI/大模型-基础' },
  { name: 'MCP', group: 'llm', tooltip: 'Model Context Protocol，多Agent上下文通信协议', link: '/vault/Knowledge/AI/n8n AI Agent 工作流' },
  { name: 'PyTorch', group: 'nlp', tooltip: '深度学习框架，模型训练与推理核心工具', link: '/vault/Knowledge/AI/深度学习-核心工具' },
  { name: 'BERT', group: 'nlp', tooltip: '预训练模型，商品短文本分类基座模型', link: '/vault/Knowledge/AI/Transformer' },
  { name: '模型压缩', group: 'nlp', tooltip: '量化/蒸馏/剪枝三路线，399MB到8MB体积压缩', link: '/vault/Knowledge/AI/AI全景概览' },
  { name: 'HuggingFace', group: 'nlp', tooltip: '模型仓库与推理工具链', link: '/vault/Knowledge/AI/LangChain Models 组件' },
  { name: 'FastText', group: 'nlp', tooltip: '轻量化文本分类兜底方案', link: '/vault/Knowledge/AI/NLP-文本预处理' },
  { name: 'Milvus', group: 'eng', tooltip: '电商RAG知识库向量存储，支撑1000+条目混合检索', link: '/vault/Knowledge/AI/Milvus 向量数据库' },
  { name: 'Redis', group: 'eng', tooltip: '三级缓存实现，缓存命中率60%+', link: '/vault/Knowledge/Engineering/Redis 核心概念' },
  { name: 'FastAPI', group: 'eng', tooltip: 'API服务框架，支撑高并发接口请求' },
  { name: 'MySQL', group: 'eng', tooltip: '业务数据持久化存储', link: '/vault/Knowledge/Engineering/MySQL 数据库基础' },
  { name: 'Docker', group: 'eng', tooltip: '容器化部署，实现环境一致性', link: '/vault/Knowledge/Engineering/Docker' },
  { name: 'Streamlit', group: 'eng', tooltip: '快速Demo原型搭建，内部工具演示', link: '/vault/Knowledge/Engineering/Streamlit 入门' },
]
const tagGroups = [
