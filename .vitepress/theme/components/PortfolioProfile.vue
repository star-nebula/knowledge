...
const techTags: TechTag[] = [
  { name: 'LangGraph', group: 'llm', tooltip: '电商选品多Agent编排框架，实现8阶段Agent工作流', link: '/vault/笔记/🧩 AI 框架与 Agent/LangChain Agents 组件' },
  { name: 'DeepSeek', group: 'llm', tooltip: '核心推理模型，用于选品分析、客服意图识别', link: '/vault/笔记/🤖 AI 大模型/DeepSeek' },
  { name: 'ReAct', group: 'llm', tooltip: 'Agent推理范式，实现工具调用与思维链推理', link: '/vault/笔记/🧩 AI 框架与 Agent/LangChain Agents 组件' },
  { name: 'vLLM', group: 'llm', tooltip: '本地模型推理部署框架，支撑14B模型低延迟服务', link: '/vault/笔记/🤖 AI 大模型/大模型-知识扩展' },
  { name: 'LoRA', group: 'llm', tooltip: '模型微调技术，用于垂直领域模型适配', link: '/vault/笔记/🤖 AI 大模型/大模型-基础' },
  { name: 'MCP', group: 'llm', tooltip: 'Model Context Protocol，多Agent上下文通信协议', link: '/vault/笔记/🧩 AI 框架与 Agent/n8n AI Agent 工作流' },
  { name: 'PyTorch', group: 'nlp', tooltip: '深度学习框架，模型训练与推理核心工具', link: '/vault/笔记/🤖 AI 大模型/深度学习-核心工具' },
  { name: 'BERT', group: 'nlp', tooltip: '预训练模型，商品短文本分类基座模型', link: '/vault/笔记/🤖 AI 大模型/Transformer 架构与实现' },
  { name: '模型压缩', group: 'nlp', tooltip: '量化/蒸馏/剪枝三路线，399MB到8MB体积压缩', link: '/vault/笔记/🤖 AI 大模型/AI全景概览' },
  { name: 'HuggingFace', group: 'nlp', tooltip: '模型仓库与推理工具链', link: '/vault/笔记/🧩 AI 框架与 Agent/LangChain Models 组件' },
  { name: 'FastText', group: 'nlp', tooltip: '轻量化文本分类兜底方案', link: '/vault/笔记/🔍 RAG 与向量检索/NLP-文本预处理' },
  { name: 'Milvus', group: 'eng', tooltip: '电商RAG知识库向量存储，支撑1000+条目混合检索', link: '/vault/笔记/🔍 RAG 与向量检索/Milvus 向量数据库' },
