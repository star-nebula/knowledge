...
1. [本地环境搭建](01-本地环境搭建) — 安装 Node.js 和 pnpm
2. [本地预览](02-本地预览) — 启动开发服务器，实时查看修改效果
3. [GitHub Pages 自动部署](<03-GitHub Pages 自动部署>) — 配置工作流和 Pages 设置
4. [常见问题 FAQ](<04-常见问题 FAQ>) — 部署过程中可能遇到的问题及解决方案
