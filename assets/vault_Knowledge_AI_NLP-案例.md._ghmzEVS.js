...
<span class="line"></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#61AFEF;">predict_rnn</span><span style="--shiki-light:#24292E;--shiki-dark:#ABB2BF;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#98C379;">&#39;zhang&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#ABB2BF;">)</span></span></code></pre></div><h3 id="seq2seq-英译法" tabindex="-1">Seq2seq 英译法 <a class="header-anchor" href="#seq2seq-英译法" aria-label="Permalink to “Seq2seq 英译法”">​</a></h3><h6 id="案例介绍-1" tabindex="-1">案例介绍 <a class="header-anchor" href="#案例介绍-1" aria-label="Permalink to “案例介绍”">​</a></h6><ul><li><p>使用 基于GRU的seq2seq模型架构 实现翻译</p><p><img src="`+y+`"></p></li><li><p>seq2seq模型架构分析:</p><ul><li><p>seq2seq模型架构包括三部分，分别是encoder(编码器)、decoder(解码器)、中间语义张量c。其中编码器和解码器的内部实现都使用了GRU模型</p></li><li><p>图中表示的是一个中文到英文的翻译：欢迎 来 北京 → welcome to BeiJing。编码器首先处理中文输入&quot;欢迎 来 北京&quot;，通过GRU模型获得每个时间步的输出张量，最后将它们拼接成一个中间语义张量c；接着解码器将使用这个中间语义张量c以及每一个时间步的隐层张量, 逐个生成对应的翻译语言</p></li></ul></li><li><p>数据集介绍</p><p><code>eng-fra-v2.txt</code>​</p><div class="language-python"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light one-dark-pro" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;" tabindex="0" dir="ltr"><code><span class="line"></span>
<span class="line"></span>
<span class="line"></span>
