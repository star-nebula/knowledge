import{_ as r,a8 as p,o as d,c as B,ah as a,a as i,K as n,L as h,a3 as t}from"./chunks/framework.BetTUW3j.js";import"./chunks/theme.DDdwhJji.js";const f=JSON.parse('{"title":"NLP-案例","description":"","frontmatter":{"title":"NLP-案例","created":"2026-05-23T00:00:00.000Z","tags":["NLP","案例"],"type":"步骤操作","related":[],"category":["🤖 AI大模型","NLP基础"]},"headers":[],"relativePath":"vault/Knowledge/AI/NLP-案例.md","filePath":"vault/Knowledge/AI/NLP-案例.md","lastUpdated":1785140936000}'),y={name:"vault/Knowledge/AI/NLP-案例.md"};function g(c,s,A,E,F,o){const l=p("VPNolebaseInlineLinkPreview"),k=p("NolebaseGitContributors"),e=p("NolebaseGitChangelog");return d(),B("div",null,[s[13]||(s[13]=a('<h1 id="rnn" tabindex="-1">RNN <a class="header-anchor" href="#rnn" aria-label="Permalink to “RNN”">​</a></h1><h3 id="人名分类器" tabindex="-1">人名分类器 <a class="header-anchor" href="#人名分类器" aria-label="Permalink to “人名分类器”">​</a></h3><h6 id="案例介绍" tabindex="-1">案例介绍 <a class="header-anchor" href="#案例介绍" aria-label="Permalink to “案例介绍”">​</a></h6>',3)),i("ul",null,[s[3]||(s[3]=i("li",null,[i("p",null,"目的：基于给定的人名，判断其属于哪个国家"),i("blockquote",null,[i("p",null,"关于人名分类问题:")]),i("blockquote",null,[i("p",null,"以一个人名为输入, 使用模型帮助我们判断它最有可能是来自哪一个国家的人名, 这在某些国际化公司的业务中具有重要意义, 在用户注册过程中, 会根据用户填写的名字直接给他分配可能的国家或地区选项, 以及该国家或地区的国旗, 限制手机号码位数等等")]),i("blockquote")],-1)),i("li",null,[s[1]||(s[1]=i("p",null,"数据格式说明：每一行第一个单词为人名，第二个单词为国家名。中间用制表符tab（\\t）分割",-1)),i("p",null,[n(l,{href:"name_classfication-20260321222501-c0lotfc.txt"},{default:h(()=>[...s[0]||(s[0]=[t("name_classfication.txt",-1)])]),_:1})]),s[2]||(s[2]=a(`<div class="language-python"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light one-dark-pro" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;" tabindex="0" dir="ltr"><code><span class="line"></span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#ABB2BF;">Yunokawa	Japanese</span></span></code></pre></div>`,1))])]),s[14]||(s[14]=a(`<h6 id="导入模块" tabindex="-1">导入模块 <a class="header-anchor" href="#导入模块" aria-label="Permalink to “导入模块”">​</a></h6><div class="language-python"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light one-dark-pro" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;" tabindex="0" dir="ltr"><code><span class="line"></span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#61AFEF;">predict_rnn</span><span style="--shiki-light:#24292E;--shiki-dark:#ABB2BF;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#98C379;">&#39;zhang&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#ABB2BF;">)</span></span></code></pre></div><h3 id="seq2seq-英译法" tabindex="-1">Seq2seq 英译法 <a class="header-anchor" href="#seq2seq-英译法" aria-label="Permalink to “Seq2seq 英译法”">​</a></h3><h6 id="案例介绍-1" tabindex="-1">案例介绍 <a class="header-anchor" href="#案例介绍-1" aria-label="Permalink to “案例介绍”">​</a></h6>`,20)),i("ul",null,[i("li",null,[s[5]||(s[5]=i("p",null,"使用 基于GRU的seq2seq模型架构 实现翻译",-1)),i("p",null,[n(l,{class:"route-link nolebase-route-link-invalid",href:"#",target:"_target"},{default:h(()=>[...s[4]||(s[4]=[t("image-20260324193751-vtyfy9c.png",-1)])]),_:1})])]),s[6]||(s[6]=a(`<li><p>seq2seq模型架构分析:</p><ul><li><p>seq2seq模型架构包括三部分，分别是encoder(编码器)、decoder(解码器)、中间语义张量c。其中编码器和解码器的内部实现都使用了GRU模型</p></li><li><p>图中表示的是一个中文到英文的翻译：欢迎 来 北京 → welcome to BeiJing。编码器首先处理中文输入&quot;欢迎 来 北京&quot;，通过GRU模型获得每个时间步的输出张量，最后将它们拼接成一个中间语义张量c；接着解码器将使用这个中间语义张量c以及每一个时间步的隐层张量, 逐个生成对应的翻译语言</p></li></ul></li><li><p>数据集介绍</p><p><code>eng-fra-v2.txt</code>​</p><div class="language-python"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light one-dark-pro" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;" tabindex="0" dir="ltr"><code><span class="line"></span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#ABB2BF;">i am truly sorry .  je suis vraiment desolee .</span></span></code></pre></div></li>`,2))]),s[15]||(s[15]=a(`<h6 id="导入模块-1" tabindex="-1">导入模块 <a class="header-anchor" href="#导入模块-1" aria-label="Permalink to “导入模块”">​</a></h6><ul><li><p>模块</p><div class="language-python"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light one-dark-pro" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;" tabindex="0" dir="ltr"><code><span class="line"></span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-light-font-style:inherit;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;"># train_seq2seq()</span></span></code></pre></div></li></ul><h6 id="模型评估" tabindex="-1">模型评估 <a class="header-anchor" href="#模型评估" aria-label="Permalink to “模型评估”">​</a></h6>`,15)),i("ul",null,[s[12]||(s[12]=a(`<li><p>内部评估代码</p><div class="language-python"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light one-dark-pro" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;" tabindex="0" dir="ltr"><code><span class="line"></span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#61AFEF;">evaluate_seq2seq_test</span><span style="--shiki-light:#24292E;--shiki-dark:#ABB2BF;">()</span></span></code></pre></div></li>`,2)),i("li",null,[s[8]||(s[8]=a(`<p>注意力图</p><div class="language-python"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light one-dark-pro" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;" tabindex="0" dir="ltr"><code><span class="line"></span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#61AFEF;">evaluate_model</span><span style="--shiki-light:#24292E;--shiki-dark:#ABB2BF;">()</span></span></code></pre></div><hr>`,80)),n(k),n(e)])}const _=r(y,[["render",g]]);export{f as __pageData,_ as default};
